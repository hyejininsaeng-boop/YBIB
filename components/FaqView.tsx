    ...
    <div className="p-1">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md mt-6">
          ...
          <AccordionItem title="전라북도교육청 소속 IB 프로그램 운영학교는 얼마나 되나요?">
              <p>2023년 3월 기준, 전라북도교육청에서 IB 프로그램을 운영 중인 후보학교는 총 11개교입니다. (DP 1개교, MYP 7개교, PYP 5개교). 해당 학교는 전주(효림초, 온빛중, 용북중), 익산(이리부송초, 이리팔봉초, 이리북중), 군산(군산동원중), 정읍(정읍초), 남원(남원초), 완주(봉서초), 전북외고 등입니다.</p>
          </AccordionItem>
