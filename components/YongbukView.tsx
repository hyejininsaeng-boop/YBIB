    ...
    return (
        <div className="p-1">
            ...
            <InfoCard title="용북중학교 IB 교육 목표" icon="fa-bullseye">
                ...
                <p>믿음의 진리 안에서 배움의 기쁨을 통해 글로벌리더를 양성하는 사랑의 학교</p>
                <h4><strong>인재상</strong></h4>
                <p>열린 마음으로 세상을 탐구하며 함께 성장하는 용북인</p>
                <h4><strong>사명선언문</strong></h4>
                <p>용북중학교는 하나님의 사랑 안에서, 탐구와 성찰로 자신과 세계를 이해하며, 지식과 배려로 더 나은 세상을 만들어가는 책임 있는 글로벌 리더 양성을 목표로 한다.</p>
                <p className="mt-2">학생들은 다양한 문화와 관점을 존중하며, 서로의 다름 속에서 배우고 협력하여, 평화롭고 지속 가능한 미래 사회를 함께 만들어간다.</p>
                <p className="mt-2">열린 마음으로 소통하며, 자신의 생각을 창의적으로 표현하고, 삶을 성찰하며 성장하는 배움의 여정을 이어간다.</p>
                <p className="mt-2">이를 위해, 모든 구성원은 사랑과 지혜, 협력과 존중이 흐르는 배움의 공동체로서, 모든 학생이 인류의 평화와 공존에 기여하는 빛나는 세계시민으로 자라나도록 함께 지향한다.</p>
            </InfoCard>
